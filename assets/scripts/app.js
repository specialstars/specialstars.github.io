...
function createPostElement(i, data) {
  ...
  postElement.innerHTML = `
        <div class="row" ${data.type != "event" ? `onclick="document.getElementById('modalMediaShowMoreTitle').innerHTML = this.parentElement.querySelector('h5').innerHTML; document.getElementById('modalMediaShowMoreBody').innerHTML = this.parentElement.querySelector('p').innerHTML; document.getElementById('modalMediaShowMoreImage').src = this.querySelector('.__header > img').src; document.getElementById('modalMediaShowMoreAuthor').innerHTML = this.parentElement.parentElement.querySelector('span.date').innerHTML; document.getElementById('modalMediaShowMoreTags').innerHTML = this.parentElement.querySelector('span.tags').innerHTML;"` : `onclick="document.getElementById('modalMediaShowMoreTitle').innerHTML = this.parentElement.querySelector('h5').innerHTML; document.getElementById('modalMediaShowMoreBody').innerHTML = '<b>Place:</b> ' + '${data.place}' + '<br/><b>Time: </b>'+ '${data.time}' +'<hr/><br/>' + this.parentElement.querySelector('p').innerHTML; document.getElementById('modalMediaShowMoreImage').src = this.querySelector('.__header > img').src;"`} data-bs-target="#modalMediaShowMore" data-bs-toggle="modal" title="Click here to see the full post">
      ...
      : ""
                ...
                <div class="mt-auto">
                    <div class="d-flex">
                        <span class="date me-2 ${data.type == "event" && "bg-primary text-white"
    }">${data.type != "event"
      ? date
      ...
      new Date(data.end).toDateString()
                        ...
                        <span class="tags">${data.type != "event" ? tags : "EVENT"
    }</span>
                    </div>
                </div>
            </div>
    ...
    await $firebase_database_then(postsRef, function (data) {
      ...
      var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventClick: function (info) {
          ...
          modalBody.innerHTML = `
                    <p><b>Status:</b> ${info.event.extendedProps.status == "Completed"
              ...
              : `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock-history" viewBox="0 0 16 16">
                  ...
                  <path d="M7.5 3a.5.5 0 0 1 .5.5v5.21l3.248 1.856a.5.5 0 0 1-.496.868l-3.5-2A.5.5 0 0 1 7 9V3.5a.5.5 0 0 1 .5-.5z"/>
                    ...
                    <p class="mb-0"><b>Place:</b> ${info.event.extendedProps.place}</p>
              ...
              : ""
                    ...
                    <p class="mb-0"><b>Time:</b> ${info.event.extendedProps.time}</p>
                    <p><b>Duration:</b> ${duration} day${duration > 1 ? "s" : ""
            }</p>
